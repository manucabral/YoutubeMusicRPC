...
# thanks for Jithu R Jacob [https://github.com/jithurjacob] for his amazing notification file.
# sadly it was outdated and throwing errors so I had to fix it and include it as a stand-alone file.
# #############################################################################
# ########## Libraries #############
# ##################################
# standard library
